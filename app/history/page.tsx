      ...
      <main style={{ isolation: 'isolate', position: 'relative', zIndex: 0 }}>
        ...
        <section className="bg-warm py-24 px-3 text-center">
          <div className="max-w-container-md mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">숫자로 보는 세모폰</h2>
            <p className="text-gray-600 mb-12">함께 성장한 시간들</p>

            <BentoGrid className="grid-cols-2 md:grid-cols-4 auto-rows-[180px]">
              <StatCard value="150,000" unit="명+" label="누적 고객" useBento delay={0} />
              <StatCard value="40" unit="개+" label="전국 매장" useBento delay={0.1} />
              <StatCard value="4.8" unit="★" label="고객 만족도" useBento delay={0.2} />
              <StatCard value="365" unit="일" label="사후관리" useBento delay={0.3} />
            </BentoGrid>
          </div>
        </section>
        ...
        <section className="bg-white py-24 px-3">
          <div className="max-w-container-md mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-16">연혁</h2>
