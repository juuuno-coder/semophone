      ...
      <div className="max-w-5xl mx-auto text-center">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/stores"
              className="inline-flex items-center justify-center px-10 py-5 bg-dark text-white rounded-full text-lg font-bold hover:bg-gray-800 transition-all shadow-lg hover:shadow-xl hover:-translate-y-1"
            >
              가까운 성지 찾기
